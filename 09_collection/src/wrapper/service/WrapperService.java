...
//		List<int> list = new ArrayList<int>();
	 ...
	 *  --> 클래스명.필드명 / 클래스명.메스드명() 시용 가능
	 */
	public void test2() {
		// 정수형 / 실수형 공통 필드
		System.out.println("byte 용량 : " + Byte.BYTES+ "바이트");
		System.out.println("int 용량 : " + Integer.BYTES+ "바이트");
		System.out.println("double 용량 : " + Double.BYTES+ "바이트");

		System.out.println("byte 용량 : " + Byte.SIZE + "바이트");
		System.out.println("int 용량 : " + Integer.SIZE + "바이트");
		System.out.println("double 용량 : " + Double.SIZE + "바이트");
		...
		// 다른 언어(특하 HTML,JS)에서 전달된 값이 있을 경우
