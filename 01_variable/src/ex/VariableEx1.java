...
//		System.out.println(true == 1);
		...
		// long longNum = 2147483648; // 일반 정수값은 == int(기본형)
		long longNum = 2147483648L; // 뒤에 L == ling 표기
		...
		System.out.println(test1); // 1.12345678
		System.out.println(test2); // 1.1234567890123456789
